...
import static com.netralabs.domain.PDFUACheckpoint.ORDERING_ENTRIES;

public class ValidateCIDSystemInfoOrdering implements Rule {
    private static final PDFUACheckpoint CHECKPOINT = ORDERING_ENTRIES;
    ...
    public List<FindingDTO> run(Context ctx) {
        ...
        for (int page = 1; page <= pdf.getNumberOfPages(); page++) {
            ...
            forEachFontOnPage(pdf, page, (fname, font) -> {
                ...
                if (csi == null || csi.getAsString(PdfName.Ordering) == null) {
                    out.add(new FindingDTO(Severity.ERROR, CHECKPOINT, finalPage,
                            null));
                } else {
